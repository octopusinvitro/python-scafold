...
* Rename `packagename` to your project name and put your production code there.
* Put your tests in `tests`.
* The `bin` folder has scripts for daily commands. See examples of use in the CI config file and below.
